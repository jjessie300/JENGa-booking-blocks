...
class PHPMailer
{
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img src="/FINALPROJECT307/images/a.png"> and must not be empty
     * will look for an image file in $basedir/FINALPROJECT307/images/a.png and convert it to inline.
